...
function testDetectionDiagnosticsMarkup() {
  ...
  assert.match(index, /main\.js\?v=mode-caption-1/, "main.js cache key should be refreshed");
  assert.match(index, /main\.css\?v=diagnostic-card-3/, "main.css cache key should be refreshed");
}
